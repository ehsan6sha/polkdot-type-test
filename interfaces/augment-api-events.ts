...
import type { Bytes, Null, Option, Result, Vec, bool, i32, u128, u16, u32, u64 } from '@polkadot/types-codec';
...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    fula: {
      ManifestOutput: AugmentedEvent<ApiType, [uploader: AccountId32, storage: Vec<AccountId32>, manifest: Bytes, poolId: u32], { uploader: AccountId32, storage: Vec<AccountId32>, manifest: Bytes, poolId: u32 }>;
      ManifestRemoved: AugmentedEvent<ApiType, [uploader: AccountId32, cid: Bytes, poolId: u32], { uploader: AccountId32, cid: Bytes, poolId: u32 }>;
      ...
      RemoveStorerOutput: AugmentedEvent<ApiType, [uploader: AccountId32, storage: Option<AccountId32>, cid: Bytes, poolId: u32], { uploader: AccountId32, storage: Option<AccountId32>, cid: Bytes, poolId: u32 }>;
      StorageManifestOutput: AugmentedEvent<ApiType, [uploader: AccountId32, storage: AccountId32, cid: Bytes, poolId: u32], { uploader: AccountId32, storage: AccountId32, cid: Bytes, poolId: u32 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    pool: {
       ...
       **/
      Accepted: AugmentedEvent<ApiType, [account: AccountId32, poolId: u32], { account: AccountId32, poolId: u32 }>;
      /**
       ...
       **/
      Denied: AugmentedEvent<ApiType, [account: AccountId32, poolId: u32], { account: AccountId32, poolId: u32 }>;
      /**
